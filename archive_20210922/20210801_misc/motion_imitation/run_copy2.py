# python3 motion_imitation/run_copy2.py --mode test --motion_file motion_imitation/data/motions/dog_pace.txt --model_file motion_imitation/data/policies/dog_pace.zip --visualize
...
# def model_predict(self, observation, state=None, mask=None, deterministic=False):
#     import gym 
...
#     print((-1,) + self.observation_space.shape)

"""
This is a modification of the original run.py script.
The simulation has been changed to one from the motion imitation library
specifically motion_imitation/envs/
...
...
def run(args):
    ...
    PATH = home + '/results/quadruped/latest/' + args.folder + '/' + args.exp + '/'

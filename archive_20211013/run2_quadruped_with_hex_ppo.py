...
def run(args):
    ...
    # Test
    # args.test_pol = True
    # PATH = "./output/quadruped_with_hex_ppo_20210929/"
    # # make a copy of the folder if you want to test something which is currently training
    ...
    pol = Model(args.robot, env=env, ob_size=28, ac_size=12, args=args, PATH=PATH, horizon=10000, writer=writer, max_timesteps=args.max_ts, vis=args.vis)
